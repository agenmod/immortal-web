...
export default function UploadPage() {
  return (
    <Suspense
      fallback={
        <div className="flex items-center justify-center min-h-screen text-[#8c8578]">
          加载中…
        </div>
      }
    >
      ...
      <div className="max-w-xl mx-auto px-6 py-10">
        ...
        <div className="bg-white rounded-2xl border border-[#e8e4df] shadow-sm p-6 sm:p-8">
          ...
          <div className="mb-6">
            ...
            {persona === "public-figure" && (
              <p className="mt-3 text-xs text-[#8c8578] leading-relaxed rounded-lg bg-[#f5f0eb] border border-[#e8e4df] px-3 py-2">
                ...
                请使用讲演、论文、访谈、开源社区等<strong>海外公开渠道</strong>的素材，提炼思维方式与表达框架；勿使用私人聊天或未授权内容。
              </p>
            )}
          </div>
          ...
          <div className="mb-5">
            <label className="block text-sm font-semibold text-[#1a1a1a] mb-1.5">
              简单描述一下 TA{" "}
              <span className="text-[#c4beb6] font-normal">可选</span>
            </label>
            <textarea
              value={description}
          ...
          <div className="mb-6">
            ...
            <div
              ...
              className={`mb-3 p-5 rounded-xl border-2 border-dashed text-center cursor-pointer transition-all ${
                dragOver
                  ...
                  : "border-[#e8e4df] hover:border-[#d0cac3] bg-[#faf9f7]"
              }`}
            >
              <input
                ref={fileRef}
              ...
              {uploadingCount > 0 ? (
                ...
                <>
                  ...
                  <p className="text-xs text-[#c4beb6] mt-1">
                    支持 截图(jpg/png) · PDF · Word(.docx) · txt/csv/json/md
                  </p>
                  <p className="text-xs text-[#c4beb6]">
                    可同时上传多个文件，最大 20MB/个
                  </p>
                </>
              )}
                  ...
                  <div
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg text-xs ${
                      f.status === "error"
                        ...
                        : f.status === "uploading"
                          ? "bg-[#6c5ce7]/5 border border-[#6c5ce7]/10"
                          : "bg-[#f0eeeb] border border-[#e8e4df]"
                    }`}
                  >
                    ...
                    {f.status === "uploading" ? (
                      ...
                      <button
                        ...
                        className="text-[#b5afa7] hover:text-red-400 transition-colors"
                      >
                        ✕
                      </button>
                    )}
            ...
            <div className="relative">
              <div className="absolute -top-2.5 left-3 bg-white px-2 text-xs text-[#c4beb6]">
                或者直接粘贴
              </div>
              <textarea
                value={chatText}
